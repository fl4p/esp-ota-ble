...
#if OTA_BLE_BENCH_STRATEGY == 2 || OTA_BLE_BENCH_STRATEGY == 4 || (defined(CONFIG_SPI_FLASH_YIELD_DURING_ERASE) && !defined(CONFIG_ESP_TASK_WDT_PANIC))
...
#elif OTA_BLE_BENCH_STRATEGY == 2 || OTA_BLE_BENCH_STRATEGY == 4
    {
