...
guard CommandLine.arguments.count==8, let burst=Int(CommandLine.arguments[4]),
      ...
      ["gatt","coc"].contains(CommandLine.arguments[3]),["sleep","nosleep"].contains(CommandLine.arguments[7]) else {
    print("usage: native_push_tuned IMAGE BASE gatt|coc BURST CHUNK INTERVAL sleep|nosleep");exit(2)
}
do {
