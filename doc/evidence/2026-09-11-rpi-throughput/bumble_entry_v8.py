    ...
    try:
        ...
        if 'BENCH_HCI_PACKET_OVERRIDE' in os.environ:
            ...
            if args.adapter not in ('AC:A7:F1:83:27:AD', 'usb:2357:0604') or override != 251:
                raise ValueError('packet-size experiment is restricted to the owned UB500 and 251 bytes')
            if queue.pending:
            ...
            print('EXPERIMENT NONSTANDARD HCI packet bytes advertised=%s override=%s credits_unchanged=%s'
        ...
        diagnostic = dict(transport=link._cli._backend.adapter,
                          hci_advertised_packet_bytes=advertised_packet_size,
